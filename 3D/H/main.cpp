...
class Hache{
    ...
    Hache(int cx, int cy, int radius) {
        ...
        a[1] = Point3D(cx + radius, cy - radius, 0);
        a[2] = Point3D(cx + radius, cy + radius, 0);
        a[3] = Point3D(cx - radius, cy + radius, 0);

        b[0] = Point3D(cx - radius, cy - radius, radius/2);
        b[1] = Point3D(cx + radius, cy - radius, radius/2);
        b[2] = Point3D(cx + radius, cy + radius, radius/2);
        b[3] = Point3D(cx - radius, cy + radius, radius/2);
    }
...
int main() {
    ...
    StarOne h(centerX, centerY, 200);
    Hache uno(centerX, centerY, 100);
